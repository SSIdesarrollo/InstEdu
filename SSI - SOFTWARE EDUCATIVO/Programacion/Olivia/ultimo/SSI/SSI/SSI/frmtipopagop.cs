...
namespace SSI
{
    public partial class frmtipopagop : Form
    {
        public frmtipopagop()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                if (txbtipopago.ReadOnly == false)
                {
                    ...
                    if (editar)
                    {
                        db.actualizar("Tipo_pagop", dict, "id_tipopagop=" + id);
                        txbtipopago.Text = "";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            dgvtipopago.DataSource = db.consulta_DataGridView("select *from Tipo_pagop");
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                string condicion = "id_tipopagop=" + id;
                db.eliminar("tipo_pagop", condicion);
                dgvtipopago.DataSource = db.consulta_DataGridView("select *from tipo_pagop");
                dgvtipopago.Columns[0].HeaderText = "ID Pago";
                dgvtipopago.Columns[1].HeaderText = "Pago";
