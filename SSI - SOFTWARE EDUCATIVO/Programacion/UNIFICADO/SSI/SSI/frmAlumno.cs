...
namespace SSI
{
    public partial class frmAlumno : Form
    {
       ...
       int editar = 0;
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            if (busqueda == 1)
            {
                if (editar == 1)
                {
                    ...
                    lblnumcarne.Show(); lblguion1.Show(); lblguion2.Show(); lblcarnerama.Hide(); lblcarnerama.Text = "00"; lblcarneaño.Hide(); lblcarneaño.Text = "00"; lblcarnealumno.Show(); lblcarnealumno.Text = "00";
        ...
        private void cmbalumnorama_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ready)
            {
                ...
                if (guardado == 1)
                {
                    lblcarnealumno.Text = codigoalumno;
                }
                lblcarnerama.Show();
                lblcarneaño.Show();
                lblcarnealumno.Show();
       ...
       */ }
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    lblnumcarne.Hide(); lblguion1.Hide(); lblguion2.Hide(); lblcarnerama.Hide(); lblcarneaño.Hide(); lblcarnealumno.Hide();
        ...
        private void cmbalumnociclo_SelectedIndexChanged(object sender, EventArgs e)
        {
