...
namespace SSI
{
    public partial class frmasignacioncursos : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            string query = "select Asigcurso_idAsigcurso as 'Codigo De Asignacion', Ciclo_idCiclo as 'Codigo De Ciclo', Rama_Cod_rama as 'Rama', Curso_Cod_curso as 'Codigo De Curso' from detalleasigcurso order by Asigcurso_idAsigcurso";
        ...
        {
            /*string query = "select Codigo_final, Nombre_alumnos as 'Nombre De Alumno' from alumnos";

            dgasignacioncurso1.DataSource = db.consulta_DataGridView(query);*/
        }
    }
}
